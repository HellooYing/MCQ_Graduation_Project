    ...
    public String reg(Model model, @RequestParam("username") String username,
        ...
        try {
            ...
            if (map.containsKey("ticket")) {
                ...
                return CloudUtil.getJSONString(0, "注册成功");
            } else {
                return CloudUtil.getJSONString(1, map);
            }

        } catch (Exception e) {
            logger.error("注册异常" + e.getMessage());
            return CloudUtil.getJSONString(1, "注册异常");
        }
    }
    ...
    public String login(Model model, @RequestParam("username") String username,
        ...
        try {
            ...
            if (map.containsKey("ticket")) {
                ...
                return CloudUtil.getJSONString(0, "登录成功");
            } else {
                return CloudUtil.getJSONString(1, map);
            }
            ...
            return CloudUtil.getJSONString(1, "登录异常");
        }
    }
